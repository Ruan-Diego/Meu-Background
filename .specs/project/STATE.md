...
| 2026-04-10 | **Accessibility audit** and **SEO & meta tags** moved from M2 to **Milestone 5** as **M5-F04** / **M5-F05** | Deferred as future work; **M2** scoped to **i18n (M2-F02)** only |
| 2026-04-10 | **Character summary card** moved from **M2-F03** to **M5-F06** | Lives **outside the wizard** (e.g. share / gallery); idea for future — see **ROADMAP** M5 |
